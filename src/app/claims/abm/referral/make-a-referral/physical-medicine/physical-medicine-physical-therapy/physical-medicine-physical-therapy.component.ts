...
@Component({
  selector: 'healthe-physical-medicine-physical-therapy',
  templateUrl: './physical-medicine-physical-therapy.component.html',
  styleUrls: ['./physical-medicine-physical-therapy.component.scss'],
  providers: [provideWizardBaseStep(PhysicalMedicinePhysicalTherapyComponent)]
})
export class PhysicalMedicinePhysicalTherapyComponent
  ...
  specificDateConfig: SpecificDateFormArrayConfig = {
    formTitle: 'Physical Therapy Services',
    serviceActionType: 'Physical Therapy',
    stepName: this.stepName,
    addDateButtonLabel: 'Add Physical Therapy Service',
    ...
    deleteItemModal: {
      deleteItemTitle: 'Delete Physical Therapy Service?',
      deleteItemMessage:
        'Are you sure that you would like to remove the selected Physical Therapy Service?'
    },
    controls: [
      [
        {
