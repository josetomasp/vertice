...
@Component({
  selector: 'healthe-diagnostics-ct-scan',
  templateUrl: './diagnostics-ct-scan.component.html',
  styleUrls: ['./diagnostics-ct-scan.component.scss'],
  providers: [provideWizardBaseStep(DiagnosticsCtScanComponent)]
})
export class DiagnosticsCtScanComponent extends WizardDateStepComponent
  implements OnInit {
  @Input()
  locations$;
  ...
  specificDateConfig: SpecificDateFormArrayConfig = {
    formTitle: 'CT Scan Services',
    serviceActionType: 'CT Scan',
    stepName: this.stepName,
    addDateButtonLabel: 'Add CT Service',
    ...
    deleteItemModal: {
      deleteItemTitle: 'Delete CT Service?',
      deleteItemMessage:
        'Are you sure that you would like to remove the selected CT Service?'
    },
    controls: [
      [
        {
          ...
          label: 'CONTRAST TYPE',
          placeholder: 'Select a Contrast Type',
