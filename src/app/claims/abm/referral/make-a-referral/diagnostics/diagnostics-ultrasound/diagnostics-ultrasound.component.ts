...
@Component({
  selector: 'healthe-diagnostics-ultrasound',
  templateUrl: './diagnostics-ultrasound.component.html',
  styleUrls: ['./diagnostics-ultrasound.component.scss'],
  providers: [provideWizardBaseStep(DiagnosticsUltrasoundComponent)]
})
export class DiagnosticsUltrasoundComponent extends WizardDateStepComponent
  implements OnInit {
  @Input()
  locations$;
  ...
  specificDateConfig: SpecificDateFormArrayConfig = {
    formTitle: 'Ultrasound Services',
    serviceActionType: 'Ultrasound',
    stepName: this.stepName,
    addDateButtonLabel: 'Add Ultrasound Service',
    ...
    deleteItemModal: {
      deleteItemTitle: 'Delete Ultrasound Service?',
      deleteItemMessage:
        'Are you sure that you would like to remove the selected Ultrasound Service?'
    },
    controls: [
      [
        {
