...
@Component({
  selector: 'healthe-transportation-detailed-post-submit-lodging',
  templateUrl: './transportation-detailed-post-submit-lodging.component.html',
  styleUrls: ['./transportation-detailed-post-submit-lodging.component.scss']
})
export class TransportationDetailedPostSubmitLodgingComponent
