...
export class PrescriptionHistoryService {
  ...
  getPrescriptionHistory(dateRange: Range): Observable<ActivityResponse> {
  ...
  public prescriptionHistoryExport(
    ...
    return new Observable((observer: Observer<string>) => {
      ...
      return this.http
        .post(getApiUrl('prescriptionHistoryExport'), queryForm, httpOptions)
        .pipe(
        ...
        .subscribe(
          (response) => {
            ...
            let filename =
              'PrescriptionHistory_' + hexDecode(queryForm.claimNumber) + '_';
