...
import { SingleDateOverlayComponent } from './components/single-date-overlay/single-date-overlay.component';
import { CalendarOverlayConfig } from '@healthe/vertice-library';

const DEFAULT_CONFIG: CalendarOverlayConfig = {
  panelClass: 'daterange-overlay',
  hasBackdrop: true,
  backdropClass: 'daterange-overlay-backdrop',
